...
- Create your free account on our [website](https://getprofile.miliukov.dev/register).
- From your [dashboard](https://getprofile.miliukov.dev/dashboard), create an **app** (e.g., "My AI App").
...
```bash
curl -X POST "https://getprofile.miliukov.dev/api/v1/profile/abc123" \
...
```bash
curl -X GET "https://getprofile.miliukov.dev/api/v1/profile/abc123" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
